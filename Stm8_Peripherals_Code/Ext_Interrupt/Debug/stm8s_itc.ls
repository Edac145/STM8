 ...
 446                     ; 102 ITC_PriorityLevel_TypeDef ITC_GetSoftwarePriority(ITC_Irq_TypeDef IrqNum)
 446                     ; 103 {
 447                     	switch	.text
 ...
 455                     ; 105     uint8_t Value = 0;
 457  002b 0f02          	clr	(OFST+0,sp)
 459                     ; 106     uint8_t Mask = 0;
 461                     ; 109     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 463                     ; 112     Mask = (uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U));
 ...
 493  004c               L14:
 494                     ; 116     case ITC_IRQ_TLI: /* TLI software priority can be read but has no meaning */
 494                     ; 117     case ITC_IRQ_AWU:
 494                     ; 118     case ITC_IRQ_CLK:
 494                     ; 119     case ITC_IRQ_PORTA:
 494                     ; 120         Value = (uint8_t)(ITC->ISPR1 & Mask); /* Read software priority */
 ...
 503  0055               L34:
 504                     ; 122     case ITC_IRQ_PORTB:
 504                     ; 123     case ITC_IRQ_PORTC:
 504                     ; 124     case ITC_IRQ_PORTD:
 504                     ; 125     case ITC_IRQ_PORTE:
 504                     ; 126         Value = (uint8_t)(ITC->ISPR2 & Mask); /* Read software priority */
 ...
 513  005e               L54:
 514                     ; 137     case ITC_IRQ_SPI:
 514                     ; 138     case ITC_IRQ_TIM1_OVF:
 514                     ; 139         Value = (uint8_t)(ITC->ISPR3 & Mask); /* Read software priority */
 ...
 523  0067               L74:
 524                     ; 141     case ITC_IRQ_TIM1_CAPCOM:
 524                     ; 142 #ifdef STM8S903
 524                     ; 143     case ITC_IRQ_TIM5_OVFTRI:
 524                     ; 144     case ITC_IRQ_TIM5_CAPCOM:
 524                     ; 145 #else
 524                     ; 146     case ITC_IRQ_TIM2_OVF:
 524                     ; 147     case ITC_IRQ_TIM2_CAPCOM:
 524                     ; 148 #endif /*STM8S903*/
 524                     ; 149 
 524                     ; 150     case ITC_IRQ_TIM3_OVF:
 524                     ; 151         Value = (uint8_t)(ITC->ISPR4 & Mask); /* Read software priority */
 ...
 533  0070               L15:
 534                     ; 153     case ITC_IRQ_TIM3_CAPCOM:
 534                     ; 154     case ITC_IRQ_UART1_TX:
 534                     ; 155     case ITC_IRQ_UART1_RX:
 534                     ; 156     case ITC_IRQ_I2C:
 534                     ; 157         Value = (uint8_t)(ITC->ISPR5 & Mask); /* Read software priority */
 ...
 543  0079               L35:
 544                     ; 165     case ITC_IRQ_UART3_TX:
 544                     ; 166     case ITC_IRQ_UART3_RX:
 544                     ; 167     case ITC_IRQ_ADC2:
 544                     ; 168 #endif /*STM8S208 or STM8S207 or STM8AF52Ax or STM8AF62Ax */
 544                     ; 169 
 544                     ; 170 #if defined(STM8S105) ||defined(STM8S103) ||defined(STM8S905) || defined(STM8AF626x)
 544                     ; 171     case ITC_IRQ_ADC1:
 544                     ; 172 #endif /*STM8S105, STM8S103 or STM8S905 or STM8AF626x */
 544                     ; 173 
 544                     ; 174 #ifdef STM8S903
 544                     ; 175     case ITC_IRQ_TIM6_OVFTRI:
 544                     ; 176 #else
 544                     ; 177     case ITC_IRQ_TIM4_OVF:
 544                     ; 178 #endif /*STM8S903*/
 544                     ; 179         Value = (uint8_t)(ITC->ISPR6 & Mask); /* Read software priority */
 ...
 553  0082               L55:
 554                     ; 181     case ITC_IRQ_EEPROM_EEC:
 554                     ; 182         Value = (uint8_t)(ITC->ISPR7 & Mask); /* Read software priority */
 ...
 563                     ; 185         break;
 565  0089               L702:
 566                     ; 188     Value >>= (uint8_t)(((uint8_t)IrqNum % 4u) * 2u);
 ...
 583                     ; 190     return((ITC_PriorityLevel_TypeDef)Value);
 ...
 680                     ; 207 void ITC_SetSoftwarePriority(ITC_Irq_TypeDef IrqNum, ITC_PriorityLevel_TypeDef PriorityValue)
 680                     ; 208 {
 681                     	switch	.text
 ...
 689                     ; 210     uint8_t Mask = 0;
 691                     ; 211     uint8_t NewPriority = 0;
 693                     ; 214     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 695                     ; 215     assert_param(IS_ITC_PRIORITY_OK(PriorityValue));
 697                     ; 218     assert_param(IS_ITC_INTERRUPTS_DISABLED);
 699                     ; 222     Mask = (uint8_t)(~(uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U)));
 701  00a2 9e            	ld	a,xh
 ...
 717                     ; 225     NewPriority = (uint8_t)((uint8_t)(PriorityValue) << (((uint8_t)IrqNum % 4U) * 2U));
 ...
 748  00d5               L112:
 749                     ; 230     case ITC_IRQ_TLI: /* TLI software priority can be written but has no meaning */
 749                     ; 231     case ITC_IRQ_AWU:
 749                     ; 232     case ITC_IRQ_CLK:
 749                     ; 233     case ITC_IRQ_PORTA:
 749                     ; 234         ITC->ISPR1 &= Mask;
 751  00d5 c67f70        	ld	a,32624
 752  00d8 1401          	and	a,(OFST-1,sp)
 753  00da c77f70        	ld	32624,a
 754                     ; 235         ITC->ISPR1 |= NewPriority;
 ...
 762  00e7               L312:
 763                     ; 238     case ITC_IRQ_PORTB:
 763                     ; 239     case ITC_IRQ_PORTC:
 763                     ; 240     case ITC_IRQ_PORTD:
 763                     ; 241     case ITC_IRQ_PORTE:
 763                     ; 242         ITC->ISPR2 &= Mask;
 765  00e7 c67f71        	ld	a,32625
 766  00ea 1401          	and	a,(OFST-1,sp)
 767  00ec c77f71        	ld	32625,a
 768                     ; 243         ITC->ISPR2 |= NewPriority;
 ...
 776  00f9               L512:
 777                     ; 254     case ITC_IRQ_SPI:
 777                     ; 255     case ITC_IRQ_TIM1_OVF:
 777                     ; 256         ITC->ISPR3 &= Mask;
 779  00f9 c67f72        	ld	a,32626
 780  00fc 1401          	and	a,(OFST-1,sp)
 781  00fe c77f72        	ld	32626,a
 782                     ; 257         ITC->ISPR3 |= NewPriority;
 ...
 790  010b               L712:
 791                     ; 260     case ITC_IRQ_TIM1_CAPCOM:
 791                     ; 261 #ifdef STM8S903
 791                     ; 262     case ITC_IRQ_TIM5_OVFTRI:
 791                     ; 263     case ITC_IRQ_TIM5_CAPCOM:
 791                     ; 264 #else
 791                     ; 265     case ITC_IRQ_TIM2_OVF:
 791                     ; 266     case ITC_IRQ_TIM2_CAPCOM:
 791                     ; 267 #endif /*STM8S903*/
 791                     ; 268 
 791                     ; 269     case ITC_IRQ_TIM3_OVF:
 791                     ; 270         ITC->ISPR4 &= Mask;
 793  010b c67f73        	ld	a,32627
 794  010e 1401          	and	a,(OFST-1,sp)
 795  0110 c77f73        	ld	32627,a
 796                     ; 271         ITC->ISPR4 |= NewPriority;
 ...
 804  011d               L122:
 805                     ; 274     case ITC_IRQ_TIM3_CAPCOM:
 805                     ; 275     case ITC_IRQ_UART1_TX:
 805                     ; 276     case ITC_IRQ_UART1_RX:
 805                     ; 277     case ITC_IRQ_I2C:
 805                     ; 278         ITC->ISPR5 &= Mask;
 807  011d c67f74        	ld	a,32628
 808  0120 1401          	and	a,(OFST-1,sp)
 809  0122 c77f74        	ld	32628,a
 810                     ; 279         ITC->ISPR5 |= NewPriority;
 ...
 818  012f               L322:
 819                     ; 288     case ITC_IRQ_UART3_TX:
 819                     ; 289     case ITC_IRQ_UART3_RX:
 819                     ; 290     case ITC_IRQ_ADC2:
 819                     ; 291 #endif /*STM8S208 or STM8S207 or STM8AF52Ax or STM8AF62Ax */
 819                     ; 292 
 819                     ; 293 #if defined(STM8S105) ||defined(STM8S103) ||defined(STM8S905) || defined(STM8AF626x)
 819                     ; 294     case ITC_IRQ_ADC1:
 819                     ; 295 #endif /*STM8S105, STM8S103 or STM8S905 or STM8AF626x */
 819                     ; 296 
 819                     ; 297 #ifdef STM8S903
 819                     ; 298     case ITC_IRQ_TIM6_OVFTRI:
 819                     ; 299 #else
 819                     ; 300     case ITC_IRQ_TIM4_OVF:
 819                     ; 301 #endif /*STM8S903*/
 819                     ; 302         ITC->ISPR6 &= Mask;
 821  012f c67f75        	ld	a,32629
 822  0132 1401          	and	a,(OFST-1,sp)
 823  0134 c77f75        	ld	32629,a
 824                     ; 303         ITC->ISPR6 |= NewPriority;
 ...
 832  0141               L522:
 833                     ; 306     case ITC_IRQ_EEPROM_EEC:
 833                     ; 307         ITC->ISPR7 &= Mask;
 835  0141 c67f76        	ld	a,32630
 836  0144 1401          	and	a,(OFST-1,sp)
 837  0146 c77f76        	ld	32630,a
 838                     ; 308         ITC->ISPR7 |= NewPriority;
