 ...
 599  007d 85            	popw	x
 600  007e 87            	retf
 646                     ; 161 void GPIO_WriteLow(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 646                     ; 162 {
 647                     	switch	.text
 648  007f               f_GPIO_WriteLow:
 650  007f 89            	pushw	x
 651       00000000      OFST:	set	0
 654                     ; 163     GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 663  0085 85            	popw	x
 664  0086 87            	retf
 710                     ; 174 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 710                     ; 175 {
 711                     	switch	.text
 712  0087               f_GPIO_WriteReverse:
 714  0087 89            	pushw	x
 715       00000000      OFST:	set	0
 718                     ; 176     GPIOx->ODR ^= (uint8_t)PortPins;
 720  0088 f6            	ld	a,(x)
 ...
 726  008c 85            	popw	x
 727  008d 87            	retf
 764                     ; 185 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 764                     ; 186 {
 765                     	switch	.text
 766  008e               f_GPIO_ReadOutputData:
 770                     ; 187     return ((uint8_t)GPIOx->ODR);
 772  008e f6            	ld	a,(x)
 775  008f 87            	retf
 ...
 822  0092 87            	retf
 889                     ; 207 BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
 889                     ; 208 {
 890                     	switch	.text
 891  0093               f_GPIO_ReadInputPin:
 893  0093 89            	pushw	x
 894       00000000      OFST:	set	0
 897                     ; 209     return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 899  0094 e601          	ld	a,(1,x)
 900  0096 1406          	and	a,(OFST+6,sp)
 903  0098 85            	popw	x
 904  0099 87            	retf
 981                     ; 219 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
 981                     ; 220 {
 982                     	switch	.text
 983  009a               f_GPIO_ExternalPullUpConfig:
 985  009a 89            	pushw	x
 986       00000000      OFST:	set	0
 989                     ; 222     assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
 991                     ; 223     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 993                     ; 225     if (NewState != DISABLE) /* External Pull-Up Set*/
 995  009b 0d07          	tnz	(OFST+7,sp)
 996  009d 2708          	jreq	L174
 997                     ; 227         GPIOx->CR1 |= (uint8_t)GPIO_Pin;
 999  009f e603          	ld	a,(3,x)
1000  00a1 1a06          	or	a,(OFST+6,sp)
1001  00a3 e703          	ld	(3,x),a
1003  00a5 2009          	jra	L374
1004  00a7               L174:
1005                     ; 230         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
